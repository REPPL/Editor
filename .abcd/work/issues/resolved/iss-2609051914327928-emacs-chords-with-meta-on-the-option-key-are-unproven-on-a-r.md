...
resolution: "The bundler dropped the Emacs keymap; annotations ignored, bundle guarded, modeline reports an empty keymap"
impact: fix
resolved_by:
  commit: "e9b510f"
---
...
- pursued: the shipped bundle must carry the keymap the tests run; wrong if a future toolchain honours the annotations differently
